...
class OldObject : public OldModel
{/*
...
public:
    explicit OldObject(const Transform& transform, const glm::vec4& color = glm::vec4(1.0f));
    explicit OldObject(const glm::vec3& position = glm::vec3(0.0f), const glm::vec4& color = glm::vec4(1.0f));
